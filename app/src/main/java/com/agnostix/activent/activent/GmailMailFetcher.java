...
public class GmailMailFetcher {
    ...
    private static final String CLIENT_SECRET_PATH = "client_secret_670535564721-hpmh9uavog50q52q9f765tojr57hs3am.apps.googleusercontent.com.json";

    private static GoogleClientSecrets clientSecrets;

    public static void fetchThreads() throws IOException {
        ...
        String url = flow.newAuthorizationUrl().setRedirectUri(GoogleOAuthConstants.OOB_REDIRECT_URI)
                .build();
        Log.d("Gmail Output","Please open the following URL in your browser then type"
        ...
        for (Thread thread : threads) {
            Log.d("Gmail Output", "Thread ID: " + thread.getId());
        }
    }
}
